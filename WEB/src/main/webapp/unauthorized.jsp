...
<head>
    ...
    <title>Jurassic World | Restricted</title>
    <!-- Font -->
    ...
    <style>
        ...
        #bg-image {
            ...
            width: 100vw;
            height: 100vh;
            background: url('https://static1.srcdn.com/wordpress/wp-content/uploads/2025/07/jurassic-world-rebirth-d-rex-1.jpg') no-repeat center center;
        ...
        @keyframes shake {
            0% {
                transform: translate(-2px, -40%) rotate(-1deg);
            }
            100% {
                transform: translate(2px, -40%) rotate(1deg);
            }
