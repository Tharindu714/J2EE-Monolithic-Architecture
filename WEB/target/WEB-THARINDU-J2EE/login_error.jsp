...
<head>
    ...
    <title>Jurassic World | Login Error</title>
    <!-- Font -->
    ...
    <style>
        ...
        #bg-image { position:fixed; top:0; left:0; width:100vw; height:100vh;
            background:url('https://wallpapers.com/images/hd/jurassic-park-enraged-t-rex-eajxr57laey9b2mb.jpg') no-repeat center center;
